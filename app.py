...
# --- SEED DATA ---
SEED_AREAS = [("BAN", "BANIYAS AREA"), ("DXB", "Dubai Area"), ("MUS", "MUSAFFAH AREA"), ("KLF", "KHALIFA CITY AREA"), ("TCA", "TOURIST CLUB AREA"), ("KLD", "KHALIDIYA AREA"), ("ARP", "AIRPORT AREA"), ("ALNJ", "AL AIN JIMMY AREA"), ("ALNC", "AL AIN CITY"), ("WRG", "WESTERN REGION"), ("AUH1", "ABU DHABI WH-1"), ("AUH", "Abu Dhabi"), ("KIZ", "KIZAD, CPC"), ("BUH", "BUHAIRAH"), ("ALQ-2", "Dubai Al Quoz - Rasal Khoor , Business B"), ("JFZ", "JAFZA City Pharmacy Stores"), ("SHJ", "Sharjah Stores"), ("QUS", "Al Qusais & Mamzar Area Dubai"), ("RAK", "Ras Al Khaimah & Umm Al Quwain"), ("FUJ", "Fujairah & Kalba & Dhaid"), ("AJM", "Ajman"), ("SHJS", "Sharjah & Sanaiya & Al Nahda"), ("SHJK", "Sharjah & King Faizal & Zahrah St"), ("SHJR", "Sharjah & Rolla & Taawun Area"), ("DXBI", "Deira In & Rigga & Naif St"), ("DXBO", "Deira Out & Mirdif & Rashidiya Area"), ("BUR", "Bur Dubai & Karama & Mankhol Area"), ("JUM", "Dubai Jumairah & Satwa Area"), ("ALQ", "Dubai Al Quoz & Awir & Barsha Area"), ("JA", "Dubai Jebal Ali & DIP Area"), ("DIC", "DIC City Pharmacy Store"), ("AD", "AUH City Pharmacy Store"), ("ALN", "Al Ain City Pharmacy Store"), ("HAT", "Hatta & Al Madam Area")]
SEED_VEHICLES = [("M 95321", "PICK-UP"), ("C 47055", "PICK-UP"), ("B 14813", "BUS"), ("C 58107", "PICK-UP"), ("C 58801", "VAN"), ("16 47645", "BUS"), ("I 85664", "PICK-UP"), ("I 86488", "VAN"), ("R 96871", "BUS"), ("U 65986", "PICK-UP"), ("U 65988", "VAN"), ("U 65990", "VAN"), ("V-83576", "VAN"), ("V-84049", "VAN"), ("V-84050", "VAN"), ("W 49535", "PICK-UP"), ("W 49536", "VAN"), ("W 49539", "VAN"), ("W 49540", "VAN"), ("O 72506", "VAN"), ("O 72533", "PICK-UP"), ("O 72548", "PICK-UP"), ("O 72567", "VAN"), ("O 72578", "VAN"), ("O 72579", "VAN"), ("O 72581", "VAN"), ("D 85038", "VAN"), ("D 85076", "VAN"), ("D 85823", "VAN"), ("C 26596", "BUS"), ("V 60857", "VAN"), ("N 31329", "VAN"), ("N 32094", "VAN"), ("N 32119", "VAN"), ("N 32126", "VAN"), ("N 33680", "VAN"), ("E 18104", "VAN"), ("E 18316", "VAN"), ("BB 72473", "BUS"), ("I 71528", "PICK-UP"), ("W 11792", "VAN"), ("T 26701", "VAN"), ("CC 98174", "VAN"), ("CC 98175", "VAN"), ("CC 98176", "VAN")]
SEED_DRIVERS = [("AD056", "NAUSHAD ALI"), ("AD060", "TINTU JOSEPH"), ("AD054", "VIJU NAIR"), ("AD067", "SREEKANTH"), ("AD038", "RAHAMATULLAH"), ("AD063", "MOHAMMED SHEREEF"), ("AD055", "AHAMAD JAN"), ("AD068", "MOHAMED ANSAR"), ("AD047", "Michael De Torres"), ("AD066", "ANSARI"), ("AD062", "NIJAVUDEEN"), ("AD065", "SABIR SHAH"), ("AD039", "H. SAGUL AMEED"), ("AD053", "Mohamed Shefeeq"), ("AD046", "MUSTHAFA . KA"), ("AD061", "YASAR ARAFATH"), ("SH003", "RAHUL RAJENDRAN"), ("AD045", "ESLAM SABRI"), ("AD050", "SHAHID ALI"), ("AD041", "MOHD. MUSTHAFA"), ("AD051", "ABDUL JALEEL"), ("AD064", "FAYAZ KHAN"), ("AD057", "SHEKKEER PH"), ("AD021", "CUSTOMER"), ("AD004", "ADIL SHAH GULAM"), ("AD006", "ABDUL NAEEM"), ("AD010", "RAHMATH BUNAIRY"), ("AD013", "FAZAL NAEM"), ("AD014", "NISAAR AHMED"), ("AD023", "FAISAL"), ("AD025", "ALI AHAMAD"), ("AD026", "NADAR SHAH"), ("AD022", "MOHAMMED GHANI"), ("AD029", "ABDUL AZIZ"), ("AD033", "RASHID"), ("D106", "Mohammed Shereef K V"), ("D081", "Musthafa Kadangod"), ("D094", "Shuhaib Mullantakath"), ("D083", "Asaf Khan Fazal"), ("SBP1", "SEBA MED PROMOTION"), ("D076", "Rahmatullah Mohammed"), ("D067", "Shebin Kabeer"), ("D096", "Ahmad Jan Mughal"), ("SRV", "Service Dept BUH"), ("D100", "Adil Ghulam"), ("D104", "Mahammed Ansar"), ("D086", "Abdul Jaleel Nadakkavu"), ("D105", "Fayaz Khan RS"), ("D087", "Abdul Naeem"), ("D108", "Ansari Ithayathullah"), ("D103", "Jamseer PV Ibrahim"), ("D080", "Shahid Ali khan"), ("D107", "Muneeb Hussain"), ("D085", "Rahul R.P"), ("D095", "Islam Sabri"), ("D089", "Jisam K Saleem"), ("SLM", "SALAMA PACKING"), ("D072", "Rahmat Bunairy"), ("D073", "Mohamed Mustafa Kummalil"), ("D063", "Ajmal Ali Akbar"), ("D097", "Shekkeer P Hamza"), ("D059", "Jeham Sher AUH"), ("D099", "Muhammed Noushad P"), ("CPC001", "Danish Mohammed"), ("BUH002", "Mohamed Khaled"), ("D078", "Mahammad Arif"), ("D075", "Michael DE Torres"), ("D061", "Said Alavy"), ("D082", "Rashid Meethal"), ("D088", "Saheer Ali V Z"), ("D079", "Nadar Shah Shah"), ("D102", "Mohammed Nasiruddeen"), ("D098", "Muhammed Aslam K"), ("D071", "Fazal Naeem Abdur Rahim"), ("D101", "Tintu V Joseph"), ("D058", "Nazeer Khan AUH"), ("D074", "Nisar Ahamed Shah"), ("D090", "Faisal Mahmood"), ("MED1", "Kathleen Grace"), ("D070", "Mohamed Ghani"), ("D092", "Mohamed Shefeeq.MP"), ("D093", "Viju Nair"), ("D068", "Ali Ahamed"), ("D049", "Abdul Jabbar"), ("D051", "Mohammed Ibrahim"), ("D052", "Noushad Ali"), ("D050", "Abdul Mansoor"), ("D047", "Ahmed Faraj"), ("D048", "Moideen Azeez"), ("C001", "Collected By Customer"), ("D010", "Nasar"), ("D011", "Imran Khan"), ("D019", "Muhammed Kunji"), ("D023", "Sabir Shah"), ("D024", "Sadiq Shah"), ("D026", "Jahaberudheen"), ("D029", "Baderudheen"), ("SLPO", "Delivered by LPO Dept"), ("D033", "Naeem Fazal"), ("D037", "Nijavudeen"), ("D038", "Ismail Korokkaran"), ("D035", "Shaul Hameed"), ("D036", "Rashid Baderzaman"), ("D040", "Hussain Mohammed"), ("D042", "Gulam Khan Mohammad"), ("D044", "Zainul Abid"), ("D032", "Sayd Mubarak"), ("D034", "Adil Hassan"), ("D046", "Azeez Abdulla"), ("D054", "Sameer Zakariyah"), ("SH002", "GULAM KHAN"), ("SH001", "SADIQ SHA"), ("SH004", "Zainulabid"), ("AD069", "MOH KUNHI"), ("C002", "OTHERS"), ("D027", "Sultan"), ("D064", "Shabeer Ali A.Rahman"), ("D109", "Yousuf Nobi Shakib")]
SEED_HELPERS = [("AH039", "RABIYA"), ("AH031", "HAJA MOIDEEN"), ("AH036", "SYED MAISAM"), ("AH037", "RASHEED"), ("AH038", "AUREL"), ("AH033", "JOSEPH"), ("AH034", "MUBARAK"), ("AH042", "LORLDWINE"), ("AH044", "ISMAIL"), ("AH041", "ABBAS"), ("AH040", "AMANULLHA"), ("AH043", "CHARL-VINCE"), ("AH002", "RAFEEQ"), ("AH012", "SAYED ALI"), ("AH020", "LATHIF"), ("AH021", "RAMSHEED"), ("AH022", "NAIK"), ("AH025", "FAZAL HADI"), ("AH027", "REJITHA"), ("AH030", "SHAHID"), ("AH40", "RAJESH"), ("H117", "Mahammad Nawaz PM"), ("H115", "Omar AlSaeed"), ("H111", "Muhammed Saif VS"), ("H130", "Javed Akhtar"), ("H077", "Ihab Mohamad Kaddour"), ("H107", "Abdul Razak"), ("H123", "Sheik Abdul Malik"), ("H097", "Mahdi"), ("H125", "Kadar Moideen"), ("H082", "Hassan Mohammed"), ("H083", "Shakeer"), ("H091", "Mohammed Sameem"), ("H095", "Noushad Ali"), ("H104", "Mohammed Shakeer"), ("H069", "Muhammed Shajahan"), ("H070", "A. Harshad"), ("H075", "Mohamed Hassan"), ("H116", "Munawir P Kabeer"), ("H119", "Muhammed Janees P"), ("H118", "Muhammed Shamil P"), ("H127", "Rafsal Rafeek"), ("H112", "Abbas Mohamed MA"), ("H113", "Chadi Otmani"), ("H073", "Jose John"), ("H066", "Christopherlov Brian"), ("H124", "Nethaniel Fernandez M"), ("H067", "Jansher"), ("H100", "Mohammed Sajeer"), ("H120", "Abdul Karim AS"), ("H080", "Muhammed Saleh"), ("H084", "Housine EL Amri"), ("H129", "Pratik Bista"), ("H121", "Afreen Salam"), ("H122", "Mohamed Arsath"), ("H126", "Subin Kovammal"), ("H078", "Abdul Rahman Ayyuob"), ("H079", "Dilip Siwakoti"), ("H101", "Jeffrey Gumban"), ("H109", "AL Ameen"), ("H110", "Mohammed Fameem"), ("H102", "Shameer Manikkunnummal"), ("H128", "Manil Dilusha"), ("H074", "Abdullah Leppa"), ("H098", "Caleb Manaois"), ("H099", "Muhammed Rajas"), ("H103", "Ali Akbar Hassan"), ("H087", "Elmer Flores"), ("H114", "Abdul Khader"), ("H054", "Siddik Abdulla"), ("H062", "Rakshith.p"), ("H059", "Rekhil Kodakka"), ("H063", "Janeesh mullappally"), ("H023", "Adil"), ("H024", "Mohd Musthafa"), ("H005", "Aboobacker Aliyar"), ("H011", "Sudhakaran"), ("H013", "Haris K"), ("H017", "Mujammal"), ("H021", "Saifudheen"), ("H022", "Jose Patibo"), ("H026", "Riyas Ahmed"), ("H034", "Riyasudheen Khuthubudheen"), ("H055", "Shaji"), ("H046", "Shihabudeen"), ("H049", "Shobith"), ("H050", "Ranjith. P"), ("H051", "Shar Bahadar"), ("H053", "Sabeer Ali Chemban"), ("H039", "Ranjith"), ("H041", "Axel Flores"), ("H058", "Sheik Kareem"), ("H064", "Shahul C"), ("H065", "Juancho"), ("H068", "Muhammed Shafiq"), ("H072", "Mohammed Haseeb"), ("H081", "M. Ziaudeen"), ("H085", "Afreed Mahmood"), ("H088", "Shafneed Nazar"), ("H089", "Mohamed Saleh Ibrahem Saleh"), ("H092", "Mohammed Saddam"), ("H131", "Said Ahmed Ibrahim"), ("H105", "Yousaf Nobi"), ("H132", "Ahmed Younis")]

if not FIREBASE_READY:
    c = conn.cursor()
    c.execute("SELECT COUNT(*) FROM areas")
    if c.fetchone()[0] == 0: c.executemany("INSERT INTO areas (code, name) VALUES (?, ?)", SEED_AREAS)
    c.execute("SELECT COUNT(*) FROM vehicles")
    if c.fetchone()[0] == 0: c.executemany("INSERT INTO vehicles (number, type) VALUES (?, ?)", SEED_VEHICLES)
    c.execute("SELECT COUNT(*) FROM drivers")
    if c.fetchone()[0] == 0: c.executemany("INSERT INTO drivers (name, code, veh_type, sector, restriction, anchor_area) VALUES (?, ?, ?, ?, ?, ?)", [(name, code, "VAN", "Pharma", "None", "None") for code, name in SEED_DRIVERS])
    c.execute("SELECT COUNT(*) FROM helpers")
    if c.fetchone()[0] == 0: c.executemany("INSERT INTO helpers (name, code, restriction, anchor_area) VALUES (?, ?, ?, ?)", [(name, code, "None", "None") for code, name in SEED_HELPERS])
    conn.commit()


# ==========================================
# 3. CACHE & LOGIC FUNCTIONS
# ==========================================
def clear_cache():
    st.cache_data.clear()
...
def get_experience_months(history_df, person_code, area_name):
    ...
    for _, r in records.iterrows():
        ...
        e = safe_parse_date(r['end_date']) if pd.notna(r.get('end_date')) and str(r['end_date']).strip() not in ["None", ""] else s + timedelta(days=30)
...
def is_on_vacation(vacations_df, person_name, target_date):
    ...
    for _, row in vacations_df.iterrows():
        if row['person_name'] == person_name:
            if safe_parse_date(row['start_date']) <= target_date <= safe_parse_date(row['end_date']): return True
    return False
...
def check_restriction(restriction, area_name):
    ...
    return str(restriction).lower() in area_name.lower()
...
def select_best_candidate(candidates_df, area_name, target_date, history_df, vacations_df, perf_df, partner_exp_months):
    ...
    for _, person in candidates_df.iterrows():
        ...
        if not perf_df.empty and 'person_code' in perf_df.columns:
            ...
            if not p_data.empty:
                sr, dc = p_data.iloc[0].get('success_rate', 100), p_data.iloc[0].get('delay_count', 0)
                perf_score = (sr * 0.1) - (dc * 2)
                score += perf_score
                reasons.append(f"Performance ({perf_score:.1f})")

        if score > best_score:
            best_score, best_candidate, best_reason = score, person, f"Score: {score:.1f} | " + ", ".join(reasons)
...
if choice == "1. AI Route Planner":
    ...
    if st.button("Generate Smart AI Route Plan", type="primary"):
        with st.spinner("Calculating optimal routes..."):
            drivers, helpers, areas, vehicles = load_table('drivers'), load_table('helpers'), load_table('areas'), load_table('vehicles')
            history, vacations, active_routes = load_table('history'), load_table('vacations'), load_table('active_routes')
...
# --- 2. DATABASE MANAGEMENT ---
    ...
    with tab1:
        ...
        with c_edit:
            ...
            if sel_d_code:
                ...
                e_restr = st.selectbox("Edit Restriction", RESTRICTION_OPTIONS, index=RESTRICTION_OPTIONS.index(d_data['restriction']) if d_data['restriction'] in RESTRICTION_OPTIONS else 0)
                e_anchor = st.selectbox("Edit Anchor", area_list, index=area_list.index(d_data['anchor_area']) if d_data['anchor_area'] in area_list else 0, key="d_edit_anchor")
    ...
    with tab2:
        ...
        with c_edit:
            ...
            if sel_h_code:
                ...
                e_hrestr = st.selectbox("Edit Restriction", RESTRICTION_OPTIONS, index=RESTRICTION_OPTIONS.index(h_data['restriction']) if h_data['restriction'] in RESTRICTION_OPTIONS else 0, key="eh_restr")
                e_hanchor = st.selectbox("Edit Anchor", area_list, index=area_list.index(h_data['anchor_area']) if h_data['anchor_area'] in area_list else 0, key="eh_anchor")
                c_upd, c_del = st.columns(2)
    ...
    with tab5:
        ...
        output = io.BytesIO()
        with pd.ExcelWriter(output, engine='openpyxl') as writer:
            for t in ['drivers', 'helpers', 'areas', 'vehicles', 'history', 'vacations']:
                load_table(t).to_excel(writer, sheet_name=t, index=False)
        output.seek(0)
        st.download_button("📥 Download Master Database (Excel)", data=output, file_name="Master_Database.xlsx", type="primary")
        
        uploaded_file = st.file_uploader("Upload modified Excel to Sync", type=['xlsx'])
...
# --- 3. PAST EXPERIENCE BUILDER ---
    ...
    c_add, c_edit = st.columns(2)
    area_list = load_table('areas')['name'].tolist() if not load_table('areas').empty else []
    ...
    with c_add:
        ...
        p_person = st.selectbox("Select Person", [f"{row['code']} - {row['name']}" for _, row in df_names.iterrows()] if not df_names.empty else [])
    ...
    with c_edit:
        ...
        if not history_df.empty:
            ...
            if sel_hist_str:
                ...
                e_area = st.selectbox("Edit Area", area_list, index=area_list.index(hist_data['area']) if hist_data['area'] in area_list else 0, key=f"e_area_{hist_id}")
                ed1, ed2 = st.columns(2)
                new_start = ed1.date_input("Edit Start Date", value=safe_parse_date(hist_data['date']), key=f"es_{hist_id}")
                new_end = ed2.date_input("Edit End Date", value=safe_parse_date(hist_data['end_date']), key=f"ee_{hist_id}")
                c_upd, c_del = st.columns(2)
        ...
        for df, role in [(load_table('drivers'), "Driver"), (load_table('helpers'), "Helper")]:
            for _, p in df.iterrows():
                ...
                if last_vac.empty: due_list.append({"Name": p['name'], "Role": role, "Status": "Never taken"})
                    ...
                    if (date.today() - lv_date).days > 365: due_list.append({"Name": p['name'], "Role": role, "Status": f"Last was {lv_date}"})
    ...
    with c_edit:
        ...
        if not vacs_df.empty:
            ...
            if sel_vac_str:
                ...
                ed1, ed2 = st.columns(2)
                new_vstart = ed1.date_input("Edit Start Date", value=safe_parse_date(vac_data['start_date']), key=f"vs_{vac_id}")
                new_vend = ed2.date_input("Edit End Date", value=safe_parse_date(vac_data['end_date']), key=f"ve_{vac_id}")
                c_upd, c_del = st.columns(2)
